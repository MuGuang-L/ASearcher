    ...
    def check_health(self, base_url):
        ...
        try:
            ...
            if response.status_code == 200:
                return True
            # SGLang can serve /v1/models before /health flips to 200.
            # Match launcher-side readiness checks to avoid false negatives.
            if health_req.endpoint == "/health" and health_req.method == "GET":
